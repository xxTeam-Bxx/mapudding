...
<body>
    ...
    <input type="text" id="username" name="username" value="${username}"class="c-form-text" >
    </div>
	<label for="comment">コメント:</label>
	<br>
    <textarea id="comment" name="comment" rows="4" cols="20"class="c-comment-text">${comment}</textarea>
    <br>
	<!--ゆりか編集(下記削除、上記追加
        <label for="username">ユーザー名:</label>
