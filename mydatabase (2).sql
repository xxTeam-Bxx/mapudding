...
('test1', 'nicocafe', '福岡県北九州市小倉北区足原2丁目5-29'),
('yurika', 'フラワーフラワ', '福岡県北九州市戸畑区一枝２丁目１０−５ Ｆｌｏｒａ'),
('yurika', '500ml', '福岡県北九州市門司区中町１−３１'),
('yurika', 'カフェ・シエル', '福岡県福岡市博多区博多駅前２丁目２−１ 福岡センタービル 地下2階'),
('yurika', 'シャイム', '福岡県北九州市戸畑区中本町２−５ 久保ビル'),
('test0', 'nicocafe', '福岡県北九州市小倉北区足原2丁目5-29');
...
INSERT INTO `users` (`username`, `password`, `comment`) VALUES
('test0', '123', 'こんにちは'),
('test1', '123', 'こんにちは'),
('user3', 'password123', ''),
('user4', 'password123', ''),
